...
const Footer = () => {
  ...
  return (
    <footer className={classes.root}>      
        ...
        <Grid item className={classes.logo}><img src={logo_hicsvyda} alt="Logo hics capital" className={classes.img}/> 
        </Grid>
        ...
        <Grid container className={classes.containerLogin}><Button className={classes.button} variant="contained" color="primary">Log in</Button></Grid>
      </footer>
  )
}
